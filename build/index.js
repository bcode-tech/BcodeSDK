...
var config = {
  ...
  TEST_META_TX_LOCAL: "0xdD879Cc25870424530080e64C7156C5cACF74408",
...
class PablockSDK {
  ...
  mintPablockNFT(amount, uri, webhookUrl) {
    return __async(this, null, function* () {
      try {
        ...
        const receipt = yield this.executeTransaction(tx);
        return receipt;
      } catch (err) {
